...
from communication.powertac_communication_server import GameService, SubmitService, AsyncioExecutor, submit_service, serve
...
class TestGrpcCommunicationServer(unittest.TestCase):
    ...
    def test_send_grpc_message_dispatcher(self):
        ...
        coro = gs.handlePBTimeslotComplete(msg, {})
        run_in_loop(coro)
    ...
    def test_actual_grpc_reverse(self):
