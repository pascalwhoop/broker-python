...
class PBBrokerAccept(Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> PBBrokerAccept: ...
    def MergeFrom(self, other_msg: Message) -> None: ...
    def CopyFrom(self, other_msg: Message) -> None: ...
...
class PBSimEnd(Message):
    
    def __init__(self,
        ) -> None: ...
    @classmethod
    def FromString(cls, s: bytes) -> PBSimEnd: ...
    def MergeFrom(self, other_msg: Message) -> None: ...
    def CopyFrom(self, other_msg: Message) -> None: ...
...
class GameService(Service, metaclass=ABCMeta):
    ...
    @abstractmethod
    def handlePBSimEnd(self,
        rpc_controller: RpcController,
        request: PBSimEnd,
        done: Optional[Callable[[Empty], None]],
    ) -> Future[Empty]: ...
    @abstractmethod
    def handlePBBrokerAccept(self,
        rpc_controller: RpcController,
        request: PBBrokerAccept,
        done: Optional[Callable[[Empty], None]],
    ) -> Future[Empty]: ...
...
class ConnectionService_Stub(ConnectionService):
    def __init__(self, rpc_channel: RpcChannel) -> None: ...
class SubmitService(Service, metaclass=ABCMeta):
    @abstractmethod
    def submitOrder(self,
        rpc_controller: RpcController,
        request: Empty,
        done: Optional[Callable[[PBOrder], None]],
    ) -> Future[PBOrder]: ...
    @abstractmethod
    def submitTariffSpec(self,
        rpc_controller: RpcController,
        request: Empty,
        done: Optional[Callable[[PBTariffSpecification], None]],
    ) -> Future[PBTariffSpecification]: ...
    @abstractmethod
    def submitTariffRevoke(self,
        rpc_controller: RpcController,
        request: Empty,
        done: Optional[Callable[[PBTariffRevoke], None]],
    ) -> Future[PBTariffRevoke]: ...
class SubmitService_Stub(SubmitService):
    def __init__(self, rpc_channel: RpcChannel) -> None: ...