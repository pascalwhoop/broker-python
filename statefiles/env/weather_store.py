...
class WeatherStore():
    def __init__(self, env):
        ...
        self.weather_predictions = {} #keys are origin+FC --> (360,14) as tuple --> Obj
        self.weather_reports     = {} #keys are "currentTimeslot"
    ...
    def handle_weatherForecastPrediction_new(self, line: str):
        ...
        self.weather_predictions[parts[1]] = prediction
    ...
    def handle_weatherForecast_new(self, line:str):
        ...
        for id in ids:
            ...
            if key in self.weather_predictions:
                ...
                self.weather_predictions[(int(origin),prediction.forecastTime)] = prediction
            else:
